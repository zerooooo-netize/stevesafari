  ...
  if (payStatus === "waiting") {
    return (
      <div className="text-center py-6">
        ...
        <p className="text-xs text-muted-foreground mt-1">Enter M-Pesa PIN when prompted.</p>
      </div>
    );
  }
  if (payStatus === "completed") {
    return (
      <div className="text-center py-6">
        ...
        <p className="font-medium text-sm text-green-700">Registration Complete!</p>
        <p className="text-xs text-muted-foreground mt-1">You can now apply for jobs.</p>
      </div>
    );
  }
  return (
    ...
    return (
      <div className="min-h-screen bg-background">
        ...
        <main className="container pt-24 pb-16 text-center">
          ...
          <Link to="/jobs" className="text-safari-gold underline mt-4 inline-block">
            ← Back to all jobs
          </Link>
        </main>
      </div>
      ...
      <main className="pt-20 pb-16">
        <div className="container max-w-4xl">
          ...
          {showRegistrationPrompt && (
            <div className="mb-6 bg-card border border-safari-gold/30 rounded-xl p-5 shadow-lg">
              <h3 className="font-heading font-semibold text-lg mb-2 flex items-center gap-2">
                <Sparkles className="text-safari-gold" size={20} />
                Unlock Your Journey
              </h3>
          ...
          <div className="bg-card border border-border rounded-2xl p-6 sm:p-8 shadow-card mb-6">
            <div className="flex flex-wrap items-start justify-between gap-3 mb-3">
              ...
              <div className="text-right">
                ...
                <p className="font-heading text-2xl font-bold text-safari-gold">
          ...
          <section className="bg-card border border-border rounded-2xl p-6 sm:p-8 shadow-card mb-6">
            <h2 className="font-heading font-bold text-lg mb-4 flex items-center gap-2">
              <Trophy size={18} className="text-safari-gold" /> Your Application Journey
            </h2>
          ...
          {/* Trust Strip */}
          <div className="bg-green-50 dark:bg-green-950/20 border border-green-200 dark:border-green-800 rounded-xl p-4 mb-6 flex items-start gap-3">
            <ShieldCheck className="text-green-700 dark:text-green-400 shrink-0 mt-0.5" size={20} />
            <div className="text-xs text-green-900 dark:text-green-100">
              <p className="font-semibold mb-1">Safe & Verified</p>
              <p>
                All payments via M‑Pesa (Kopo Kopo). Receipt sent instantly. Refund possible if we cannot place you.{" "}
                <Link to="/trust" className="underline font-medium">
                  Read trust policy →
                </Link>
              </p>
            </div>
          ...
          <div className="sticky bottom-0 bg-background/95 backdrop-blur-md border-t border-border -mx-4 px-4 py-4 sm:rounded-2xl sm:border sm:mx-0 sm:px-6 sm:py-5 sm:relative sm:bg-card sm:shadow-elevated">
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-3">
              ...
              >
                {applying ? (
                  <><Loader2 size={16} className="animate-spin mr-1" /> Starting...</>
                ) : hasApplied ? (
                  "Go to Dashboard"
                ) : !user ? (
                  "Sign In to Apply"
          ...
          {/* Anti-scam Warning */}
          <div className="mt-6 flex items-start gap-2 bg-yellow-50 dark:bg-yellow-950/20 border border-yellow-200 dark:border-yellow-800 rounded-xl p-4">
            <AlertCircle className="text-yellow-700 dark:text-yellow-400 shrink-0 mt-0.5" size={16} />
