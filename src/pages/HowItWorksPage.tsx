...
const HowItWorksPage = () =>{
 ...
 return (
<div className="min-h-screen bg-background"><TrustBar /><Navbar /><main className="pt-24 sm:pt-28 section-y page-x">{/* Hero */}
<section className="container section-y-sm text-center"><span className="text-sm font-medium text-safari-gold uppercase tracking-wider">Full Transparency</span><h1 className="font-heading text-3xl md:text-5xl font-bold text-foreground mt-2 mb-4">How Our Process Works
