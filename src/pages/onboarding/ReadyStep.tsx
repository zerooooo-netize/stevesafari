...
const ReadyStep = () =>{
 ...
 <><li> Final travel briefing by email/SMS</li><li>Pre-departure checklist sent 7 days before flight</li><li>Accommodation confirmation upon arrival</li></>) : (
 <><li>Document processing typically takes 3–7 days</li><li>Email notification when ready</li><li> Download from your dashboard once complete</li></>)}
